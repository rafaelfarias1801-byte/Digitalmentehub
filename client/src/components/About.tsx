...
import instagramScreen from "@assets/image_1771619197603.png";
    ...
    <section id="sobre" className="relative overflow-hidden bg-brand-pink" data-testid="section-about">
      <div className="relative py-20 md:py-28 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
          ...
          >
            <div className="relative w-[280px] md:w-[320px] transform rotate-[4deg]">
              ...
              <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[100px] h-[28px] bg-black/80 rounded-b-2xl" />
            </div>
          </motion.div>
        </div>
      </div>
