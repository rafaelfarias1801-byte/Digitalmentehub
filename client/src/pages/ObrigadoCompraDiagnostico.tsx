...
const TALLY_URL = "https://tally.so/r/aQB07q";

export default function ObrigadoCompraDiagnostico() {
    ...
    <div className="bg-brand-navy min-h-screen">
      ...
      <div className="pt-28 md:pt-36 pb-24">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="font-display text-[28px] md:text-[42px] text-white mb-8 leading-tight tracking-tight" data-testid="text-obrigado-diag-title">
              Pagamento confirmado 🎉
            </h1>

            <div className="bg-white/[0.025] border border-white/[0.05] rounded-2xl p-8 md:p-10 text-left space-y-4">
              <p className="text-white/65 text-[15px] leading-[1.8]" data-testid="text-obrigado-diag-p1">
                Recebemos a confirmação do seu pagamento com sucesso.
              </p>
              <p className="text-white/65 text-[15px] leading-[1.8]" data-testid="text-obrigado-diag-p2">
                Agora precisamos de algumas informações para iniciar seu diagnóstico.
              </p>
              <p className="text-white/65 text-[15px] leading-[1.8]" data-testid="text-obrigado-diag-p3">
            ...
            {!sent ? (
              <div className="mt-8 max-w-md mx-auto">
                ...
                <div className="space-y-3 mb-6">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-white/[0.05] border border-white/[0.08] rounded-lg pl-11 pr-4 py-3.5 text-white text-sm placeholder:text-white/25 outline-none focus:border-brand-orange/40 transition-colors"
                      data-testid="input-whatsapp-diag"
                    />
                  </div>
                </div>
                ...
                <button
                  ...
                  data-testid="button-preencher-briefing-diag"
                >
                  {sending ? "Enviando..." : "Preencher briefing"}
                </button>

                <p className="text-white/20 text-xs mt-4">
                  Ao clicar, você será redirecionado para o briefing.
                </p>
              </div>
            ) : (
              <div className="mt-8">
                ...
                <a
                  ...
                  data-testid="button-preencher-briefing-diag-again"
                >
            ...
            <p className="text-white/30 text-xs leading-relaxed mt-6 max-w-md mx-auto" data-testid="text-obrigado-diag-auxiliar">
            ...
            <div className="mt-8">
              <Link
                ...
                data-testid="button-voltar-site-diag"
              >
                Voltar para o site
              </Link>
            </div>
